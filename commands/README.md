...
3. Define the output path (save into the appropriate query folder under `output/general/`)
4. Follow the convention: all artifacts for one query go in `output/general/YYYY-MM-DD-<slug>/`
